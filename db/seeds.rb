...
puts "Creating 2 Users"
  user1 = User.create!(username: "Maximilien", avatar:"http://bit.ly/2EF3rJz", email: "maximilien@email.com", password: "123456", is_digger: true, channel_url: "channel-url1.com", nb_following: "12 000")
  user2 = User.create!(username: "Tanguy", avatar:"http://bit.ly/2Hx6P7l", email: "tanguy@email.com", password: "123456", is_digger: true, channel_url: "channel-url2.com", nb_following: "1 200")
